...
const Navbar = () => {
  ...
  return (
    <header className="fixed right-0 left-0 max-w-[1920px] mx-auto py-[1.3rem] px-[2%] lg:py-5 lg:px-[2%] flex justify-between items-center z-[100] before:content-[''] before:top-0 before:left-0 before:absolute before:w-full before:h-full before:bg-black before:z-[-1] text-white font-bold shadow-xl lg:shadow-none">
      ...
      <nav
        ...
        } top-full  absolute left-0 w-full bg-gradient-back lg:bg-gradient-back  backdrop-blur-2xl shadow-2xl shadow-gradient-back transition-all duration-500 lg:h-auto lg:static lg:w-auto lg:bg-inherit lg:backdrop-blur-0 lg:shadow-none delay-700 lg:delay-0`}
      >
